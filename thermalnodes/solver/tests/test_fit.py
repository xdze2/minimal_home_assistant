...
from thermalnodes.solver.fit import _patch_model, build_forward, fit_nls, FitResult
from thermalnodes.solver.simulate import simulate_zoh
...
class TestPatchModel:
    ...
    def test_bad_key_format_raises(self):
        from thermalnodes.solver.fit import _parse_key
